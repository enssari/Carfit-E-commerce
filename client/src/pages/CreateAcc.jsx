...
export const CreateAcc = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (!validEmail || isEmpty || !validPass) {
        console.error('Invalid email or password. Please check your inputs.');
        return;
    }
            ...
            <div id="form-wrapper">
                ...
                id="sign-up-inputs">
                    <div className='flex flex-col space-y-2' id="email-input">
                        ...
                        rounded-md pl-2 focus:outline-none duration-150
                        ${!validEmail || isEmpty ? 'border-red-600 text-red-600' : ''} `}
                    ...
                    <div className='flex flex-col space-y-2' id="password-input">
                        ...
                        <input
                        onBlur={(e) => handlePass(e.target.value)}
                        onChange={(e) => setPass(e.target.value)}
                        className={`border-solid border-[1px] border-[#cecdcd] w-[15rem] h-[2.5rem]
                        rounded-md pl-2 focus:outline-none duration-150 ${!validPass ? 'border-red-600 text-red-600' : ''}`}
                    ...
                    <div className={`pt-2`} id="sign-up-button">
                        ...
                        duration-300 active:bg-gray-500`}
                        type='submit'>
                            Sign up
                        </button>
                    </div>
